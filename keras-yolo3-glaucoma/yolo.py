...
class YOLO(object):
    _defaults = {
        "model_path": os.path.join(wd,'keras-yolo3-glaucoma/model_data/glaucoma_derived_model.h5'),
        "anchors_path":  os.path.join(wd,'keras-yolo3-glaucoma/model_data/yolo_anchors.txt'),
        "classes_path":  os.path.join(wd,'keras-yolo3-glaucoma/glaucomadata/glaucoma_classes.txt'),
        "score" : 0.3,
        "iou" : 0.45,
    ...
    def detect_image(self, image):
        ...
        font = ImageFont.truetype(font='keras-yolo3-glaucoma/font/FiraMono-Medium.otf',
